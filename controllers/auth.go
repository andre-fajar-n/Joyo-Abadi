...
func (a *auth) RenderLoginPage(c *fiber.Ctx) error {
...
func (a *auth) RenderRegisterPage(c *fiber.Ctx) error {
...
func (a *auth) Register(c *fiber.Ctx) error {
	...
	if err := a.db.Create(&registerData).Error; err != nil {
